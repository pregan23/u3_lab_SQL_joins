...
UPDATE doormen SET shift = 'Night';

--Create one new tenant, put them in any apartment you want
NSERT INTO tenants(name, age, gender, apartment_id) VALUES ('Paul Atreides', 15, 'male', 3);
...
SELECT * from apartments JOIN buildings ON apartments.building_id = buildings.id WHERE apartments.price > 2300;
